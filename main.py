...
dog_img = Image.open("dog.jpg").resize((200, 200), Image.ANTIALIAS)
dog_photo = ImageTk.PhotoImage(dog_img)

cat_img = Image.open("cat.jpg").resize((200, 200), Image.ANTIALIAS)
cat_photo = ImageTk.PhotoImage(cat_img)

bird_img = Image.open("bird.jpg").resize((200, 200), Image.ANTIALIAS)
...
for idx, btn_animal in enumerate(animal_buttons):
    btn_animal.place(x=300, y=vertical_center + idx * 220)
