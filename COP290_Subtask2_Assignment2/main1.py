...
# Function to display injured animal image in a new window
def display_injured_animal_window():
    ...
    # Display injured animal image in the new window
    injured_window.blit(injured_animal_image, ((injured_window_width - injured_animal_image.get_width()) // 2, (injured_window_height - injured_animal_image.get_height()) // 2))
    pygame.display.flip()
...
def display_injured_bird_window():
    ...
    # Display injured animal image in the new window
    injured_window.blit(injured_bird_image, ((injured_window_width - injured_bird_image.get_width()) // 2, (injured_window_height - injured_bird_image.get_height()) // 2))
    pygame.display.flip()
